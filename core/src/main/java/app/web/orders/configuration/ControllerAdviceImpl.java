package app.web.orders.configuration;

import app.web.orders.exception.ElementNotFoundException;
import app.web.orders.exception.order.UserIsNotOwnerOfOrder;
...
class ControllerAdviceImpl {
    ...
    @ExceptionHandler({UserIsNotOwnerOfOrder.class})
    ResponseEntity<HashMap<String, String>> handleForbiddenException(Exception e) {
        return createResponse(HttpStatus.FORBIDDEN, e.getLocalizedMessage());
    }
